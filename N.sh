...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
# Jangan Recode Lagi ya gayn
echo
echo
echo
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo $i" |"$cy"     Izin Recode "$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" TikusMati"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" -------"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ TAI KUCINK"$i"  |"
echo $i" |"$cy"            ~ sanguanCok"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 08998776418"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" xcyber@inbox888.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" DARK FB V1.6            "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB BR1G4D3    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" WEBDAV DEPES WEBSITE    "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" K"$i" |"
echo $i"|"$me" 6"$i" |"$cy" TOOLS BAJINGAN   "$i"|"$i"    |"$cy" E"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU BaByk  "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" N"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"NToolsSex"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Adhtya/EmailVuln
cd EmailVuln
nano EmailVuln.txt
fi
...
sleep 2
echo $cy"Terima Kasih Sudah Pakai Tool Recodean:v"
sleep 2
echo $i"Bila Ada Kesalahan Kamu Bisa Nanya Kepada Saya"
sleep 2
echo $ku"WhatsApp :"$i" 08998776418"
echo $ku"Facebook :"$i" -----&&"
sleep 2
echo $pur">> Thanks Yang Sudah Support Saya recode ea <<"
exit
fi
